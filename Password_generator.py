...
def get_yes_no(prompt):
    ...
    while True:
        ...
        if reponse in ['o', 'oui', 'y', 'yes']:
            ...
            print("⚠️  Invalid answer. Please answer with 'y' (yes) or 'n' (no).")
    ...
    try:
        ...
        while True:
            ...
            try:
                ...
                if longueur < 4:
                    print("⚠️  Length must be at least 4 characters.")
                elif longueur < 8:
                    print("⚠️  Warning: Less than 8 characters is considered weak.")
